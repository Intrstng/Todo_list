...
import { TodolistType } from '../features/Todolists/reducers/todoListsReducer';
...
export const CreateTodolist = () => {
    ...
    return <div>{JSON.stringify(state)}
        ...
        <button onClick={onClickCreateTodoHandler}>Create new todolist</button></div>
}
